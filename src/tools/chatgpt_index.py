...
EXTRACT_PROMPT = """Ты помогаешь Владимиру построить второй мозг из его диалогов с ChatGPT.

Тебе дают краткое содержание одного диалога. Решай, заслуживает ли он сохранения, и если да — извлекай факты.

Сохраняй: решения, выводы, принципы Владимира; проекты, бизнес AURA.BEYOND, клиентов; людей с контекстом; ценности; технические решения.
НЕ сохраняй: стихи, шутки, разовые переводы, generic Q&A, помощь с кодом без долгосрочной важности, one-off creative tasks.

Ответь STRICT JSON без markdown:
{"keep": true|false, "reason": "1 предложение", "category": "decision|project|person|principle|technical|junk",
 "summary": "2-4 предложения квинтэссенция", "facts": ["факт1", ...], "people": ["имя", ...], "topics": ["topic", ...]}"""
