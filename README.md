...
- [x] **Phase 7.2/7.3** — `list_google_sheet_tabs` + silent sheet navigation.
- [x] **Phase 8** — Mac Bridge: `mac_bridge_run(task)` delegates to local Claude Code with MCPs (Figma, Canva, file system) over Cloudflare Tunnel.
